...
import com.almasu.myapplication.databinding.ActivityLocationPickerBinding
...
class LocationPickerActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    internal companion object {
        ...
        const val TAG = "LOCATION_PICKER_TAG"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.toolbarGpsBtn.setOnClickListener {
            ...
            if (isGPSEnabled()){
                ...
                Utils.toast(
                    this,
                    "Локация не включена! Включите его, чтобы показать текущее местоположение"
                )
            }
        }
    ...
    private val requestLocationPermission: ActivityResultLauncher<String> =
        registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted ->
            ...
            if (isGranted){
                ...
                Utils.toast(this, "Доступ запрещен")
            }
        }
    ...
    private fun addressFromLatLng(latLng: LatLng){
        ...
        try {
            ...
            val subLocality = address.locality
